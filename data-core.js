  ...
  document.addEventListener("DOMContentLoaded", () => {
    setTimeout(() => {
      ...
      if (!document.querySelector("#year4-version-style")) {
        ...
        style.textContent = 'html body:has(.home-hero) .site-footer span::after,html body:has(.moves-workspace) .site-footer span::after{content:"v0.24.0 / YEAR 4"}';
